...
> [!tip]
> Want the visual overview first? See [the Markdown Roadmap](../roadmap.md). Joining a team that works in markdown? There's a dedicated [step-by-step onboarding path](onboarding.md) that sequences everything here for you.
