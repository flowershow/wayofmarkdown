...
- Follow [Tutorial 1: create a website from scratch](tutorials/create-a-website-from-scratch.md) -- GitHub account, one repo, one click of publish. 🎉
...
- Follow [Tutorial 2: edit your site locally](tutorials/edit-a-website-locally.md)
- Key ideas you'll pick up: cloning, committing (saving a snapshot), pushing (sharing it), and `[[wiki-links]]`
...
- Optional video: [markdown KB setup end-to-end](https://www.youtube.com/watch?v=HwkO14-nTwk)
...
- Read [Tutorial 3: collaborating with branches and pull requests](../learn/tutorial-3.md) *(outline form for now)* and the [GitHub FAQs](../kb/github-tips.md)

**You're done when**: you know why you'd make a branch and what a pull request is.

## What next?

You're operational 🎉 From here: [what you can build with markdown](../markdown-based.md), [why we work this way](../why.md), and [where else markdown shows up](../everywhere.md). Welcome to the way of markdown.
