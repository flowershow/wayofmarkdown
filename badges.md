...
The slogan generalises: **"X ❤ Markdown"** — *Obsidian ❤ Markdown*, *Our docs ❤ Markdown*, *Berlin ❤ Markdown*. Want a custom one for your tool or community? The badge is a 10-line SVG — edit the text, or [open an issue](https://github.com/flowershow/wayofmarkdown/issues) and we'll happily generate it for you.

## Who's flying it

Nobody yet — the badge launched today 😄 If you put one up, [tell us](https://github.com/flowershow/wayofmarkdown/issues) and we'll list you here. Early adopters get eternal glory in this section.
