...
- `markdown-database.md` — essay: the Markdown Database Pattern
- `docs/` — internal/dev docs (vision, naming, plans, work log) — not published
- `config.json` — Flowershow site configuration
